 ...
 *
 *  Revision : $Id: control_system_manager.c,v 1.7.4.3 2007-12-31 16:25:00 zer0
 * Exp $
 *
 */
 ...
 * - else apply filter
 */
static inline uint32_t safe_filter( int32_t ( *f )( void*, int32_t ),
                                    void* param,
                                    int32_t value )
{
 ...
 */
static inline uint32_t safe_getprocessout( int32_t ( *f )( void* ),
                                           void* param )
{
    int32_t ( *f_tmp )( void* );
    void* param_tmp;
 ...
 */
static inline void safe_setprocessin( void ( *f )( void*, int32_t ),
                                      void* param,
                                      int32_t value )
{
...
int32_t cs_do_process( struct cs* cs, int32_t consign )
{
    ...
    if( cs->enabled )
    {
        ...
        process_out_value =
            safe_getprocessout( cs->process_out, cs->process_out_params );
