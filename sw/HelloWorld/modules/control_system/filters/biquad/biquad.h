...
extern void biquad_set_numerator_coeffs( struct biquad_filter* p,
                                         int16_t b0,
                                         int16_t b1,
                                         int16_t b2 );

extern void biquad_set_deniminator_coeffs( struct biquad_filter* p,
                                           int16_t a1,
                                           int16_t a2 );

extern void biquad_set_divisor_shifts( struct biquad_filter* p,
                                       uint8_t recursive_shift,
                                       uint8_t out_shift );
 ...
 */
extern void biquad_set_series_son( struct biquad_filter* p,
                                   struct biquad_filter* son );
