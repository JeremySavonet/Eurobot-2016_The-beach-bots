...
/*
 * Implements static obstacle avoidance.
 *
...
#include "../../common/math/geometry/circles.h"
#include "../../common/math/geometry/lines.h"
#include "../../common/math/geometry/polygon.h"
...
/*
 * Instance of the obstacle avoidance system.
 *
...
struct obstacle_avoidance
{
    ...
    uint8_t valid[ MAX_PTS ];   // Used by the Dijkstra algorithm to say if a
                                // point was visited.
    ...
    uint8_t
        cur_poly_idx;   // Index of the current polygon ( for adding polygons ).
 ...
 * [in] size Number of point in the polygon.
 ...
 * [in] pol The polygon who is being set.
 * [in] x,y The coordinates of the point, in mm.
