...
#if DEBUG_LN == 1
#define DEBUG_LINES_PRINTF( lvl, args... ) \
...
uint8_t intersect_line( const line_t* l1, const line_t* l2, point_t* p )
{
    ...
    DEBUG_LINES_PRINTF( 3,
                        "l1:%2.2f,%2.2f,%2.2f l2:%2.2f,%2.2f,%2.2f\n",
                        l1->a,
                        l1->b,
                        l1->c,
                        l2->a,
...
void proj_pt_line( const point_t* p, const line_t* l, point_t* p_out )
{
    ...
    p_out->y = ( l_tmp.a * l->c - l->a * l_tmp.c ) /
               ( l->a * l_tmp.b - l_tmp.a * l->b );
    p_out->x = ( l->b * l_tmp.c - l_tmp.b * l->c ) /
               ( l->a * l_tmp.b - l_tmp.a * l->b );
}
                           ...
                           point_t* p )
{
    ...
    DEBUG_LINES_PRINTF( 3,
                        "s1:%" PRIi32 ",%" PRIi32 " s2:%" PRIi32 ",%" PRIi32 " "
